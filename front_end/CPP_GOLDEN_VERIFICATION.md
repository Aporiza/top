...
本文档说明 `front_end` 里的 C++ golden slice 验证模式。
...
```text
tools/generate_frontend_cpp_golden.py
front_end/slices/cpp_golden/cpp_golden_bsd.cpp
front_end/slices/cpp_golden/cpp_golden_bsd_macros.vh
front_end/slices/cpp_golden/include/SimCpu.h
front_end/sim/run_verilator_cpp_golden.sh
```
