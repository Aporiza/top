...
module prf_top #(
    ...
    assign {prf2exe_iss_entry_valid,
            ...
            prf2exe_iss_entry_uop_dbg} = prf2exe;
    ...
    assign pi = {iss2prf, exe2prf, dec_bcast, rob_bcast, ftq_prf_pc_resp};
    assign {prf2exe, prf_awake, ftq_prf_pc_req} = po;
