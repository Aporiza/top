...
module preiduqueue_top #(
    ...
    preiduqueue_bsd_top #(
        .W_PreIduQueueIn(W_PreIduQueueIn),   // 实际值：7002 bit，main/default 的 PreIduQueue 输入总线宽度。
        .W_PreIduQueueOut(W_PreIduQueueOut)  // 实际值：3522 bit，main/default 的 PreIduQueue 输出总线宽度。
