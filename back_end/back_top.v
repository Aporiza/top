...
module back_top #(
    ...
    // tma/dbg sideband fields from the external output.
    // ---------------------------------------------------------------------
    ...
    wire [(W_TmaMeta * COMMIT_WIDTH)-1:0]        backout_rob_commit_entry_uop_tma_drop;
    wire [(W_DebugMeta * COMMIT_WIDTH)-1:0]      backout_rob_commit_entry_uop_dbg_drop;
