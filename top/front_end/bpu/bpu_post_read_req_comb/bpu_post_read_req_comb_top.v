...
module bpu_post_read_req_comb_top #(
    parameter integer W_BpuPostReadReqCombIn  = 4949,  // actual: 4949, from bpu_top W_BpuOut
    parameter integer W_BpuPostReadReqCombOut = 4949    // actual: 4949, from bpu_top W_BpuOut
) (
