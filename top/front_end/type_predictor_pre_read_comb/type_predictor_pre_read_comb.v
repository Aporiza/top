// Formal frontend comb training unit: type_predictor_pre_read_comb.
// Canonical source: simulator-new/front-end/TypePredictor.h; type predictor table pre-read path.
//
...
module type_predictor_pre_read_comb #(
