// Formal frontend comb training unit: fetch_address_FIFO_comb.
// Canonical source: simulator-new/front-end/fifo/fetch_address_FIFO.cpp:296; fetch address FIFO comb.
//
...
module fetch_address_FIFO_comb #(
