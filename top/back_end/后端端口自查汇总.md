...
- 范围：`back_top` 与后端一级 `*_top`，并列出对应 `*_bsd_top` 的 `pi/po` 端口。
- 说明：本文件由 RTL module 声明直接生成，用于人工核对端口和 top -> bsd_top 关系。

## 总览

| 序号 | 模块                | 输入端口 | 输出端口 | 对应 BSD                        | 文件                                |
| -- | ----------------- | ---- | ---- | ----------------------------- | --------------------------------- |
| 1  | `back_top`        | 23   | 15   | -                             | `back_top.v:12`                   |
| 2  | `preiduqueue_top` | 7    | 6    | `preiduqueue_bsd_top` / 未提供定义 | `preiduqueue\preiduqueue_top.v:7` |
| 3  | `idu_top`         | 4    | 15   | `idu_bsd_top` / 未提供定义         | `idu\idu_top.v:8`                 |
| 4  | `ren_top`         | 5    | 2    | `ren_bsd_top` / 未提供定义         | `ren\ren_top.v:6`                 |
| 5  | `dispatch_top`    | 8    | 4    | `dispatch_bsd_top` / 未提供定义    | `dispatch\dispatch_top.v:7`       |
| 6  | `rob_top`         | 6    | 23   | `rob_bsd_top` / 未提供定义         | `rob\rob_top.v:6`                 |
| 7  | `isu_top`         | 5    | 3    | `isu_bsd_top` / 未提供定义         | `isu\isu_top.v:6`                 |
| 8  | `prf_top`         | 5    | 3    | `prf_bsd_top` / 未提供定义         | `prf\prf_top.v:6`                 |
| 9  | `exu_top`         | 6    | 6    | `exu_bsd_top` / 未提供定义         | `exu\exu_top.v:7`                 |
| 10 | `lsu_top`         | 9    | 6    | `lsu_bsd_top` / 未提供定义         | `lsu\lsu_top.v:8`                 |
| 11 | `csr_top`         | 3    | 10   | `csr_bsd_top` / 未提供定义         | `csr\csr_top.v:6`                 |
...
// 后端端口自查
// 模块：preiduqueue_top
// 文件：preiduqueue\preiduqueue_top.v:7
...
//   后续组员补 bsd_top 时，应保持实例名和 pi/po 连接一致。
// -----------------------------------------------------------------------------
```
